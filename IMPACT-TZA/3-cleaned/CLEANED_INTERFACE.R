...
#
# this is the interface for the impact linkage 28.6.2018
####################################################################################################
## app.R ##
...
server = function(input, output, session) {
   ...
   pok<- eventReactive(input$go, {
     ...
     # set land use change
     add<<-input$add # should be at 0 or user defined > 0 # in percent, will be devided by 100 in the luc code
