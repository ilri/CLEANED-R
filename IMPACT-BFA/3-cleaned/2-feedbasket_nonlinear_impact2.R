...
y_grass[y_grass==0]<-150
y_grass2<-y_grass*1.2* 0.001/ dm_g *grazlandHarv * grazycorr# this is in kg DM /ha * for0.001 to tons /dm to get freshweight and we need to transform
...
cropProdI<- cropProd[cropProd$productiontype == "air", YEAR]*1000/ 10000 *pixel^2 #kg/m2 

pgc<-(cropProdI-avg_cer)/cropProdI

if(nopgc==1){pgc<- 0.1158815} # replace in the base run 
