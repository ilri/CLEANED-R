...
path<-'E:/ILRI Work/Catherine DROPBOX/CLEANED - IMPACT-BFA'
setwd(path)
...
parea<-raster('1-input/spatial/rr.tif')
suit_c<-raster( '1-input/spatial/suit_c.tif')
sarea<-readOGR('1-input/spatial', layer='BFA')
...
nochange <- l210 + l202 + l201 + l200 + l190
parea[is.na(parea)]<-0
nochange_prot<-l210+l202+l201+l200+l190+parea
