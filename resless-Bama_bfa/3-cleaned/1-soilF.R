...
mprod_g<- (numcow_d*mprod_d+numcow_tl*mprod_tl)*mms_pasture_perc/100*365+(numcow_f*mprod_f+numcow_da*mprod_da+numcow_tpt*mprod_e+numcow_tpt*mprod_e*st1/12)*365 * mms_pasture_perc2/100
mprod_c<- (numcow_d*mprod_d+numcow_tl*mprod_tl)*mms_lagoon_perc/100*365+(numcow_f*mprod_f+numcow_da*mprod_da+numcow_tpt*mprod_e+numcow_tpt*mprod_e*st1/12)*365 * mms_lagoon_perc2/100 +
  (numcow_d*mprod_d+numcow_tl*mprod_tl)*mms_liquidslurry_perc/100*365+(numcow_f*mprod_f+numcow_da*mprod_da+numcow_tpt*mprod_e+numcow_tpt*mprod_e*st1/12)*365 * mms_liquidslurry_perc2/100 +
  (numcow_d*mprod_d+numcow_tl*mprod_tl)*mms_solidstorage_perc/100*365+(numcow_f*mprod_f+numcow_da*mprod_da+numcow_tpt*mprod_e+numcow_tpt*mprod_e*st1/12)*365 * mms_solidstorage_perc2/100 +
  (numcow_d*mprod_d+numcow_tl*mprod_tl)*mms_drylot_perc/100*365+(numcow_f*mprod_f+numcow_da*mprod_da+numcow_tpt*mprod_e+numcow_tpt*mprod_e*st1/12)*365 * mms_drylot_perc2/100 +
  (numcow_d*mprod_d+numcow_tl*mprod_tl)*mms_dailyspread_perc/100*365+(numcow_f*mprod_f+numcow_da*mprod_da+numcow_tpt*mprod_e+numcow_tpt*mprod_e*st1/12)*365 * mms_dailyspread_perc2/100
#slurry production  
slprod_c<-(numcow_d*mprod_d+numcow_tl*mprod_tl)*mms_digester_perc/100*365+(numcow_f*mprod_f+numcow_da*mprod_da+numcow_tpt*mprod_e+numcow_tpt*mprod_e*st1/12)*365 * mms_digester_perc2/100
...
avg_r<-cellStats(y_ricec,stat='mean')
...
names(soil_ind2)<-c("balance d'azote", "total d'azote ajoute","ajout d'azote par tête" )
soil_ind2<-data.frame(t(soil_ind2))
colnames(soil_ind2)<-c('resultat','difference','Pourcent')

##steve edits
soil_ind_val<-read.csv('1-input/parameter/soil_val.csv')
soil_ind2$val <- ifelse(soil_ind2$Pourcent <= soil_ind_val$peu, 'faible', ifelse((soil_ind2$Pourcent >= soil_ind_val$peu) & (soil_ind2$Pourcent <= soil_ind_val$peu),'moyen','important'))
...
title<-paste("Balance d'azote", name, sep=" ")
title2<-paste("Ajout d'azote", name, sep=" ")
title3<-paste("Extraction d'azote", name, sep=" ")
title4<-paste("Difference balance d'azote" , name, sep=" ")
title5<-paste("Difference ajout d'azote", name, sep=" ")
title6<-paste("Difference extraction d'azote", name, sep=" ")
