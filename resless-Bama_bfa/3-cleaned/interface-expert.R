...
fluidRow(
  ...
  box(status = "warning", width = 1, "",background ="green",
      ...
      div(style="height: 35px;",numericInput("att", "", 120, min = 60, max = 1000)),
  ...
  box(status = "warning", width = 2,"",background ="green",
      ...
      div(style="height: 35px;",textInput("mp211", "", value="**")),
      div(style="height: 35px;",numericInput("lwles", "",220 , min = 100, max = 1000)),
      div(style="height: 35px;",numericInput("myles", "", 300, min = 0, max = 1000)),
      numericInput("Des", "", 0, min = 0, max = 1)),
  box(status = "warning", width = 2, "",background ="green",
      
      div(style="height: 35px;",textInput("mp11", "", value="N/A")),
      div(style="height: 35px;",textInput("mp12", "", value="N/A")),
      div(style="height: 35px;",numericInput("numcow_d", "", 1400, min = 10, max = 10000)),
      div(style="height: 35px;",numericInput("lwis", "", 250, min = 10, max = 1000)),
      div(style="height: 35px;",numericInput("myis", "", 1000, min = 0, max = 1000)),
      textInput("mp143", "", value="N/A")),
  box(status = "warning", width = 2, " ",background ="green",
      div(style="height: 35px;",textInput("mpkk", "", value="N/A")),
      div(style="height: 35px;",textInput("mpkk1q", "", value="N/A")),
      div(style="height: 35px;",numericInput("numcow_f", "", 55000, min = 0, max = 1000000)),
      div(style="height: 35px;",numericInput("lwsis", "", 250, min = 10, max =1000 )),
      div(style="height: 35px;",textInput("mpkkr", "", value="N/A")),
      numericInput("dsis", "", 0.48, min = 0, max = 100)),
  ...
  box(status = "warning", width = 2, " ",background ="green",
      ...
      div(style="height: 35px;",numericInput("lwda", "", 200, min = 10, max =1000 )),
...
fluidRow(
  box(status = "primary",width = 12, "Feed basket wet season",background = "blue")
...
fluidRow(
  box(status = "warning", width = 2, "", background ="blue",
      ...
      textInput("7aFb", "", value="Concentrate - oil seed cake")  
      
      
  ),
  box(status = "warning", width = 2, "",background ="blue",
      div(style="height: 35px;",numericInput("efng1", "", 100, min = 0, max = 100)),
      div(style="height: 35px;",numericInput("efrc1", "", 0, min = 0, max = 100)),
      ...
      numericInput("efconos1", "", 0, min = 0, max = 100)),
  box(status = "warning", width = 2, "",background ="blue",
      div(style="height: 35px;",numericInput("lefng1", "", 100, min = 0, max = 100)),
      div(style="height: 35px;",numericInput("lefrc1", "", 0, min = 0, max = 100)),
      div(style="height: 35px;",numericInput("lefrr1", "", 0, min = 0, max = 100)),
      div(style="height: 35px;",numericInput("lefrl1", "", 0, min = 0, max = 100)),
  ...
  box(status = "warning", width = 2, "",background ="blue",
      div(style="height: 35px;",numericInput("ifng1", "", 80, min = 0, max = 100)),
      div(style="height: 35px;",numericInput("ifrc1", "", 0, min = 0, max = 100)),
      ...
      div(style="height: 35px;",numericInput("ifconc1", "", 10, min = 0, max = 100)),
      numericInput("ifconos1", "", 10, min = 0, max = 100)),
  box(status = "warning", width = 2, "",background ="blue",
      div(style="height: 35px;",numericInput("sfng1", "", 80, min = 0, max = 100)),
      div(style="height: 35px;",numericInput("sfrc1", "", 0, min = 0, max = 100)),
      ...
      numericInput("sfconos1", "", 10, min = 0, max = 100)),
  
  box(status = "warning", width = 2, "",background ="blue",
      div(style="height: 35px;",numericInput("dafng1", "", 100, min = 0, max = 100)),
      ...
      div(style="height: 35px;",numericInput("dafconc1", "", 0, min = 0, max = 100)),
      numericInput("dafconos1", "", 0, min = 0, max = 100))
  
  
  ),
fluidRow(
  box(status = "primary",width = 12, "Feed basket dry season",background = "orange")
...
fluidRow(
  ...
  box(status = "warning", width = 2, "", background ="orange",
      div(style="height: 35px;",numericInput("efng2", "", 50, min = 0, max = 100)),
      div(style="height: 35px;",numericInput("efrc2", "", 30, min = 0, max = 100)),
      div(style="height: 35px;",numericInput("efrr2", "", 20, min = 0, max = 100)),
      ...
      numericInput("efconos2", "", 0, min = 0, max = 100)),
  box(status = "warning", width = 2, "", background ="orange",
      div(style="height: 35px;",numericInput("lefng2", "", 50, min = 0, max = 100)),
      div(style="height: 35px;",numericInput("lefrc2", "", 30, min = 0, max = 100)),
      div(style="height: 35px;",numericInput("lefrr2", "", 20, min = 0, max = 100)),
  ...
  box(status = "warning", width = 2, "", background ="orange",
      div(style="height: 35px;",numericInput("ifng2", "", 35, min = 0, max = 100)),
      div(style="height: 35px;",numericInput("ifrc2", "", 35, min = 0, max = 100)),
      div(style="height: 35px;",numericInput("ifrr2", "", 10, min = 0, max = 100)),
      div(style="height: 35px;",numericInput("ifrl2", "", 10, min = 0, max = 100)),
      div(style="height: 35px;",numericInput("ifpf2", "", 0, min = 0, max = 100)),
      div(style="height: 35px;",numericInput("ifconc2", "", 5, min = 0, max = 100)),
      numericInput("ifconos2", "", 5, min = 0, max = 100)),
  box(status = "warning", width = 2, "", background ="orange",
      div(style="height: 35px;",numericInput("sfng2", "", 30, min = 0, max = 100)),
      div(style="height: 35px;",numericInput("sfrc2", "", 45, min = 0, max = 100)),
      div(style="height: 35px;",numericInput("sfrr2", "", 15, min = 0, max = 100)),
      div(style="height: 35px;",numericInput("sfrl2", "", 5, min = 0, max = 100)),
      div(style="height: 35px;",numericInput("sfpf2", "", 0, min = 0, max = 100)),
      div(style="height: 35px;",numericInput("sfconc2", "", 2.5, min = 0, max = 100)),
      numericInput("sfconos2", "", 2.5, min = 0, max = 100)),
  
  box(status = "warning", width = 2, "", background ="orange",
      div(style="height: 35px;",numericInput("dafng2", "", 30, min = 0, max = 100)),
      div(style="height: 35px;",numericInput("dafrc2", "", 50, min = 0, max = 100)),
      div(style="height: 35px;",numericInput("dafrr2", "", 15, min = 0, max = 100)),
      div(style="height: 35px;",numericInput("dafrl2", "", 5, min = 0, max = 100)),
      div(style="height: 35px;",numericInput("dafpf2", "", 0, min = 0, max = 100)),
      div(style="height: 35px;",numericInput("dafconc2", "", 0, min = 0, max = 100)),
      numericInput("dafconos2", "", 0, min = 0, max = 100)) 
...
fluidRow(
  ...
  box(status = "warning", width = 2, "", background ="teal",
      ...
      div(style="height: 35px;",numericInput("es_pasture_perc", "", 100, min = 0, max = 100)),
      ...
      div(style="height: 35px;",numericInput("es_fuel_perc", "", 0, min = 0, max = 100)),
  ...
  box(status = "warning", width = 2, "", background ="teal",
      ...
      div(style="height: 35px;",numericInput("les_dailyspread_perc", "", 0, min = 0, max = 100)),
  ...
  box(status = "warning", width = 2, "", background ="teal",
      ...
      div(style="height: 35px;",numericInput("is_solidstorage_perc", "", 100, min = 0, max = 100)),
  ...
  box(status = "warning", width = 2, "", background ="teal",
      ...
      div(style="height: 35px;",numericInput("sis_solidstorage_perc", "", 100, min = 0, max = 100)),
      ...
      div(style="height: 35px;",numericInput("sis_fuel_perc", "", 0, min = 0, max = 100)),
...
fluidRow(
  ...
  box(status = "warning", width = 2, "", background ="green",
      div(style="height: 35px;",numericInput("st1", "", 6, min = 1, max = 11)),
      numericInput("st2", "", 6, min = 1, max = 11))
),
...
fluidRow(
  box(status = "primary", width = 10, "", background ="green",
      div(style="height: 35px;",textInput("1q", "", value="dry season (October_April)")),
      textInput("2q", "", value="wet season (May_September ) ")),
  box(status = "primary", width = 2, "", background ="green",
      div(style="height: 35px;",numericInput("ds", "", 7, min = 1, max = 11)),
      numericInput("ws", "", 5, min = 1, max = 11))
),
...
fluidRow(
  ...
  box(status = "primary", width = 2, "", background ="green",
      div(style="height: 35px;",numericInput("ws_st1", "", 3, min = 1, max = 11)),
      numericInput("ds_st1", "", 3, min = 1, max = 11))
),
...
fluidRow(
  box(status = "warning", width = 10, "", background ="blue",
      div(style="height: 35px;",textInput("1n", "", value="manure production from a cow in the traditional system per day")),
      div(style="height: 35px;",textInput("2n", "", value="manure production from a cow from in the troupeau laitier per day")),
      div(style="height: 35px;",textInput("3n", "", value="manure production from a cow in the fattening system per day")),
      div(style="height: 35px;",textInput("3n", "", value="manure production from a cow in the draft system per day")),
      textInput("4n", "", value="manure production from a cow in the dairy system per day")),
  
  box(status = "warning", width = 2, "", background ="blue",
      div(style="height: 35px;",numericInput("mprod_e", "", 2, min = 0, max = 20)),
      div(style="height: 35px;",numericInput("mprod_tl", "", 3, min = 0, max = 20)),
      div(style="height: 35px;",numericInput("mprod_f", "", 3, min = 0, max = 20)),
      div(style="height: 35px;",numericInput("mprod_da", "", 3, min = 0, max = 20)),
      numericInput("mprod_d", "", 3, min = 0, max = 20))
),
...
fluidRow(
  ...
  box(status = "warning", width = 2, "", background ="teal",
      div(style="height: 35px;",numericInput("manc", "", 0.4, min = 0, max = 100)),
      div(style="height: 35px;",numericInput("manl", "", 0, min = 0, max = 100)),
      div(style="height: 35px;",numericInput("manpf", "", 0, min = 0, max = 100)),
      div(style="height: 35px;",numericInput("manr", "", 0.4, min = 0, max = 100)),
...
fluidRow(
  ...
  box(status = "warning", width = 2, "", background ="orange",
      div(style="height: 35px;",numericInput("pgc", "", 0, min = -1, max = 1)),
      div(style="height: 35px;",numericInput("pgl", "", 0.0, min = -1, max = 1)),
      div(style="height: 35px;",numericInput("pgpf", "", 0.0, min = -1, max = 1)),
      div(style="height: 35px;",numericInput("pgg", "", 0, min = -1, max = 1)),
      div(style="height: 35px;",numericInput("pgr", "", 0.0, min = -1, max = 1)),
      div(style="height: 35px;",numericInput("perc_til", "", 0, min = -1, max = 1)),
      ...
      div(style="height: 35px;",numericInput("perc_inlow", "", 100, min = -1, max = 100)),
      div(style="height: 35px;",numericInput("perc_inmedium", "",0, min = -1, max = 100)),
      div(style="height: 35px;",numericInput("perc_inhighnoman", "", 0, min = -1, max =100)),
...
fluidRow(
  ...
  box(status = "warning", title=" Land use change chosen", width = 4, "", background ="orange",
...
ui <- dashboardPage(
  ...
  dashboardHeader(title = "SAIRLA PROJECT : CLEANED INTERFACE SYSTEM FOR BURKINA FASO-ADVANCED USERS",titleWidth=1000,
...
server = function(input, output, session) {
  ...
  observeEvent(input$ws, {
   ...
   pok<- eventReactive(input$go, {
     ...
     #path<<-'D:/MOSEVICTOR_PC/MOSE_E/ILRI_SHINY_APP2017/CLEANED_BURKINAFASO2017/CLEANED_UPDATED/CLEANED - Burkina'
    ...
    myles<<-input$myles # http://www.abcburkina.net/fr/nos-dossiers/la-filiere-lait/586-18-performances-laitieres-des-vaches-de-races-locales
     ...
     lefrl1<<-input$lefrl1
     #planted fodder (0)
     lefpf1<<-input$lefpf1  #Feed scenario 20 
     # concentrates cereal (maize bran) (0)
     lefconc1<<-input$lefconc1
     # concentrates oilseed cake (0)
     lefconos1<<-input$lefconos1
     #check if a 100%
     ...
     # concentrates cereal (maize bran) (0)
     # lefconc2<<- 0
     lefconc2<<-input$lefconc2
     # concentrates oilseed cake (0)
     # lefconos2<<- 0
     lefconos2<<-input$lefconos2
     #check if a 100%
     ...
     # les_lagoon_perc<<- 00
     les_lagoon_perc<<-input$les_lagoon_perc
     # les_liquidslurry_perc<<-00
     les_liquidslurry_perc<<-input$les_liquidslurry_perc
     # les_solidstorage_perc<<-20
     les_solidstorage_perc<<-input$les_solidstorage_perc
     # les_drylot_perc<<-00
     les_drylot_perc<<-input$les_drylot_perc
     # les_pasture_perc<<-80
     les_pasture_perc<<-input$les_pasture_perc
     # les_dailyspread_perc<<-00
     les_dailyspread_perc<<-input$les_dailyspread_perc
     # les_digester_perc<<-00
     les_digester_perc<<-input$les_digester_perc
     # les_fuel_perc<<-00
     les_fuel_perc<<-input$les_fuel_perc
     # les_other_perc<<-00
     les_other_perc<<-input$les_other_perc
     #do by season 
    ...
    perc_notil <<- input$perc_notil
     ...
     lucc<<-input$lucc#1=running with land use change scenario
     lucs<<-1
     ...
     # setwd(path)
     # 
     # route<<-1 #1=running with a scenario that account for the agreed pastoral routes
     # 
     # #add the path to the changes in land use rasters
     # #path to changing cropland i.e. cropland change layer
     # tpath<<-'1-input/spatial/routes.tif'
     # tzpath<<-'1-input/spatial/zones.tif'
     # if (lucs=='LUC1'){
     #   route<- raster(tpath)
     #   zone<-raster(tzpath)
     # }
