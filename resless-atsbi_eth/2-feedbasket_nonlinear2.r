...
erc_ct<-(erc_es * numcow_es + numcow_sis * erc_sis + numcow_is* erc_is+erc_da *numcow_da)

##############################################################################################
#calculate energy requirement in by season  from each feed source 
#dry  season 
ng_es<-(efng1/100*numcow_es*erc_es)*ds/12 * 365 +  (efng2/100* numcow_es*erc_es ) *ws/12 * 365
ng_sis<-(sfng1/100*numcow_sis*erc_sis)*ds/12 * 365+  (sfng2/100* numcow_sis*erc_sis) *ws/12 * 365
ng_is<-(ifng1/100*numcow_is*erc_is)*ds/12 * 365+  (ifng2/100* numcow_is*erc_is ) *ws/12 * 365
ng_da<-(dafng1/100*numcow_da*erc_da)*ds/12 * 365+  (dafng2/100* numcow_da*erc_da ) *ws/12 * 365
ng_sh<-(shfng1/100*numsheep*erc_sh)*ds/12 * 365+  (shfng2/100* numsheep*erc_sh ) *ws/12 * 365

rc_es<-(efrc1/100*numcow_es*erc_es )*ds/12 * 365+ (efrc2/100* numcow_es*erc_es )*ws/12 * 365
rc_sis<-( sfrc1/100*numcow_sis*erc_sis )*ds/12 * 365+ (sfrc2/100*numcow_sis*erc_sis )*ws/12 * 365
rc_is<-( ifrc1/100 * numcow_is*erc_is  )*ds/12 * 365+ (ifrc2/100 * numcow_is*erc_is)*ws/12 * 365
rc_da<-(dafrc1/100*numcow_da*erc_da )*ds/12 * 365+ (dafrc2/100* numcow_da*erc_da )*ws/12 * 365
rc_sh<-(shfrc1/100*numsheep*erc_sh )*ds/12 * 365+ (shfrc2/100* numsheep*erc_sh )*ws/12 * 365

rr_es<-(efrr1/100* numcow_es*erc_es )*ds/12 * 365+ (efrr2/100* numcow_es*erc_es )*ws/12 * 365
rr_sis<-(sfrr1/100*numcow_sis * erc_sis  )*ds/12 * 365+ (sfrr2/100*numcow_sis*erc_sis  )*ws/12 * 365
rr_is<-(ifrr1/100 * numcow_is*erc_is )*ds/12 * 365+ (ifrr2/100 * numcow_is*erc_is )*ws/12 * 365
rr_da<-(dafrr1/100 * numcow_da*erc_da  )*ds/12 * 365+ (dafrr2/100 * numcow_da*erc_da )*ws/12 * 365
rr_sh<-(shfrr1/100 * numsheep*erc_sh  )*ds/12 * 365+ (shfrr2/100 * numsheep*erc_sh )*ws/12 * 365

rl_es<-(efrl1/100*numcow_es*erc_es )*ds/12 * 365+ (efrl2/100* numcow_es*erc_es )*ws/12 * 365
rl_sis<-(sfrl1/100*numcow_sis * erc_sis )*ds/12 * 365+ (sfrl2/100*numcow_sis*erc_sis )*ws/12 * 365
rl_is<-( ifrl1/100 * numcow_is*erc_is  )*ds/12 * 365+ (ifrl2/100 * numcow_is*erc_is )*ws/12 * 365
rl_da<-( dafrl1/100 * numcow_da*erc_da  )*ds/12 * 365+ (dafrl2/100 * numcow_da*erc_da )*ws/12 * 365
rl_sh<-( shfrl1/100 * numsheep*erc_sh  )*ds/12 * 365+ (shfrl2/100 * numsheep*erc_sh )*ws/12 * 365

pf_es<-(efpf1/100*numcow_es*erc_es )*ds/12 * 365+ (efpf2/100* numcow_es*erc_es)*ws/12 * 365
pf_sis<-(sfpf1/100*numcow_sis * erc_sis )*ds/12 * 365+ (sfpf2/100*numcow_sis*erc_sis)*ws/12 * 365
pf_is<-(ifpf1/100 * numcow_is*erc_is )*ds/12 * 365+ ( ifpf2/100 * numcow_is*erc_is)*ws/12 * 365
pf_da<-(dafpf1/100 * numcow_da*erc_da )*ds/12 * 365+ ( dafpf2/100 * numcow_da*erc_da)*ws/12 * 365
pf_sh<-(shfpf1/100 * numsheep*erc_sh )*ds/12 * 365+ ( shfpf2/100 * numsheep*erc_sh)*ws/12 * 365

conc_es<-(efconc1/100*numcow_es*erc_es )*ds/12 * 365+ (efconc2/100* numcow_es*erc_es)*ws/12 * 365
conc_sis<-(sfconc1/100*numcow_sis*erc_sis )*ds/12 * 365+ (sfconc2/100*numcow_sis*erc_sis)*ws/12 * 365
conc_is<-( ifconc1/100 * numcow_is*erc_is)*ds/12 * 365+ (ifconc2/100 * numcow_is*erc_is)*ws/12 * 365
conc_da<-(dafconc1/100 * numcow_da*erc_da )*ds/12 * 365+ (dafconc2/100 * numcow_da*erc_da)*ws/12 * 365
conc_sh<-(shfconc1/100 * numsheep*erc_sh )*ds/12 * 365+ (shfconc2/100 * numsheep*erc_sh)*ws/12 * 365

conos_es<-(efconos1/100*numcow_es*erc_es)*ds/12 * 365+ (efconos2/100* numcow_es*erc_es)*ws/12 * 365
conos_sis<-(sfconos1/100*numcow_sis*erc_sis)*ds/12 * 365+ (sfconos2/100*numcow_sis*erc_sis)*ws/12 * 365
conos_is<-(ifconos1/100 * numcow_is*erc_is)*ds/12 * 365+ ( ifconos2/100 * numcow_is*erc_is)*ws/12 * 365
conos_da<-(dafconos1/100 * numcow_da*erc_da)*ds/12 * 365+ (dafconos2/100 * numcow_da*erc_da)*ws/12 * 365
conos_sh<-(shfconos1/100 * numsheep*erc_sh)*ds/12 * 365+ (shfconos2/100 * numsheep*erc_sh)*ws/12 * 365

hay_es<-(efhay1/100*numcow_es*erc_es )*ds/12 * 365+ (efhay2/100*numcow_es*erc_es )*ws/12 * 365
hay_sis<-( sfhay1/100*numcow_sis * erc_sis)*ds/12 * 365+ (sfhay2/100*numcow_sis * erc_sis)*ws/12 * 365
hay_is<-(ifhay1/100 * numcow_is*erc_is )*ds/12 * 365+ (ifhay2/100 * numcow_is*erc_is )*ws/12 * 365
hay_da<-(dafhay1/100 * numcow_da*erc_da )*ds/12 * 365+ (dafhay2/100 * numcow_da*erc_da )*ws/12 * 365
hay_sh<-(shfhay1/100 * numsheep*erc_sh )*ds/12 * 365+ (shfhay2/100 * numsheep*erc_sh )*ws/12 * 365

sil_es<-(efsil1/100*numcow_es*erc_es)*ds/12 * 365+ (efsil2/100*numcow_es*erc_es  )*ws/12 * 365
sil_sis<-(sfsil1/100*numcow_sis * erc_sis)*ds/12 * 365+ ( sfsil2/100*numcow_sis * erc_sis )*ws/12 * 365
sil_is<-(ifsil1/100 * numcow_is*erc_is )*ds/12 * 365+ ( ifsil2/100 * numcow_is*erc_is)*ws/12 * 365
sil_da<-(dafsil1/100 * numcow_da*erc_da )*ds/12 * 365+ (dafsil2/100 * numcow_da*erc_da )*ws/12 * 365
sil_sh<-(shfsil1/100 * numsheep*erc_sh )*ds/12 * 365+ (shfsil2/100 * numsheep*erc_sh )*ws/12 * 365
...
#total energy required from each source of food per species 
# big ruminant 
...
# fraction of each fodder at landscape scale over the year step for cattle. 
fng_ct <-   ng_ct/(ng_ct+rc_ct+rl_ct+pf_ct+conc_ct+conos_ct+hay_ct+sil_ct)
frc_ct <-   rc_ct/(ng_ct+rc_ct+rl_ct+pf_ct+conc_ct+conos_ct+hay_ct+sil_ct)
frr_ct <-   rr_ct/(ng_ct+rc_ct+rl_ct+pf_ct+conc_ct+conos_ct+hay_ct+sil_ct)
frl_ct <-   rl_ct/(ng_ct+rc_ct+rl_ct+pf_ct+conc_ct+conos_ct+hay_ct+sil_ct)
fpf_ct <-   pf_ct/(ng_ct+rc_ct+rl_ct+pf_ct+conc_ct+conos_ct+hay_ct+sil_ct)
fconc_ct <- conc_ct/(ng_ct+rc_ct+rl_ct+pf_ct+conc_ct+conos_ct+hay_ct+sil_ct)
fconos_ct <-conos_ct/(ng_ct+rc_ct+rl_ct+pf_ct+conc_ct+conos_ct+hay_ct+sil_ct)
fhay_ct <-  hay_ct/(ng_ct+rc_ct+rl_ct+pf_ct+conc_ct+conos_ct+hay_ct+sil_ct)
fsil_ct <-  sil_ct/(ng_ct+rc_ct+rl_ct+pf_ct+conc_ct+conos_ct+hay_ct+sil_ct)

# fraction of each fodder at landscape scale over the year step for sheep 
fng_sh<-   ng_sh/(ng_sh+rc_sh+rl_sh+pf_sh+conc_sh+conos_sh+hay_sh+sil_sh)
frc_sh<-   rc_sh/(ng_sh+rc_sh+rl_sh+pf_sh+conc_sh+conos_sh+hay_sh+sil_sh)
frr_sh<-   rr_sh/(ng_sh+rc_sh+rl_sh+pf_sh+conc_sh+conos_sh+hay_sh+sil_sh)
frl_sh<-   rl_sh/(ng_sh+rc_sh+rl_sh+pf_sh+conc_sh+conos_sh+hay_sh+sil_sh)
fpf_sh<-   pf_sh/(ng_sh+rc_sh+rl_sh+pf_sh+conc_sh+conos_sh+hay_sh+sil_sh)
fconc_sh<- conc_sh/(ng_sh+rc_sh+rl_sh+pf_sh+conc_sh+conos_sh+hay_sh+sil_sh)
fconos_sh<-conos_sh/(ng_sh+rc_sh+rl_sh+pf_sh+conc_sh+conos_sh+hay_sh+sil_sh)
fhay_sh<-  hay_sh/(ng_sh+rc_sh+rl_sh+pf_sh+conc_sh+conos_sh+hay_sh+sil_sh)
fsil_sh<-  sil_sh/(ng_sh+rc_sh+rl_sh+pf_sh+conc_sh+conos_sh+hay_sh+sil_sh)
...
de_ct<-(fng_ct*d_g+frc_ct*d_rc+frl_ct*d_rl+fpf_ct*d_pf+fconc_ct*d_conc+fconos_ct*d_conos+fhay_ct*d_h+fsil_ct*d_s)*100 
de_sh<-(fng_sh*d_g+frc_sh*d_rc+frl_sh*d_rl+fpf_sh*d_pf+fconc_sh*d_conc+fconos_sh*d_conos+fhay_sh*d_h+fsil_sh*d_s)*100 


#REM = ratio of net energy available in a diet for maintenance to digestible energy consumed
rem_ct=(1.123-(4.092*10^-3*de_ct)+(1.126*10^-5*de_ct^2)-(25.4/de_ct))
rem_sh=(1.123-(4.092*10^-3*de_sh)+(1.126*10^-5*de_sh^2)-(25.4/de_sh))
...
ar_rl<-fw_rl/avg_rl 
ar_pf<-(fw_pf  + fwg_sil )/(fy_pf*(1+pgpf)*1000/10000*pixel[[1]]^2*rfpf) # we consider silage  as planted forrage hay is considered to be from natural grass 3.5.2018
...
# for indicator purpose let us compute area of planted fodder in km2 12.10.2018
ar_pf_ha<-ar_pf*pixel[[1]]^2/1000000
# 
# 
...
# percentage of cropland under planted fodder
...
if (diff_ar >0 ){
  import_c = 0
  totmaize= cellStats(y_maizec,stat='mean')*ar_rc*pixel[[1]]^2/1000000+  cellStats(y_maizec,stat='mean')*(diff_ar)
...
mms_liquidslurry<-(es_liquidslurry_perc*numcow_es+is_liquidslurry_perc*numcow_is)
mms_solidstorage<-(es_solidstorage_perc*numcow_es+is_solidstorage_perc*numcow_is)
...
mms_dailyspread<-(es_dailyspread_perc*numcow_es+is_dailyspread_perc*numcow_is)
...
mms_liquidslurry2<-(sis_liquidslurry_perc*numcow_sis+da_liquidslurry_perc*numcow_da)
mms_solidstorage2<-(sis_solidstorage_perc*numcow_sis+da_solidstorage_perc*numcow_da)
...
mms_dailyspread2<-(sis_dailyspread_perc*numcow_sis+da_dailyspread_perc*numcow_da)
...
# for sheep
mms_params1 <- read.csv('1-input/parameter/MMSparams.csv')
mms_params <-subset(mms_params1 , mms_params1$Species==species5&mms_params1$Region==region2)
B03<-mms_params$B0
...
prod_ind<-data.frame(milk,cattle_meat, sheep_meat, totmaize ,croparea,grazarea, ar, ar_g,import_c, import_g , fw_contot,fw_conc2, fw_conos2,ar_pf_ha,pf_crop_ratio)
...
names(prod_ind2)<-c("milk produced", "cattlemeat produced", "sheep meat", "cereal produced", 'total area available for crop', 'total area available for pasture', "crop area used", 'pasture area used'
                    , "import crop", 'import pasture', 'concentrate total', 'concentrate-bran', 'concentrate - oil seed cake',"planted fodder", "planted fodder crop ratio")
