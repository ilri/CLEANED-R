...
body <- dashboardBody( 
  ...
  mainPanel(
    ...
    tabsetPanel(id = "inTabset",
                        tabPanel(title = "Feed basket", value = "panel1", ""),
...
server = function(input, output, session) {
   ...
   pok<- eventReactive(input$go, {
     ...
     source('3-cleaned/2-feedbasket_nonlinear2Simple.r')
...
output$plot <- renderText(
  ...
  pok1<- eventReactive(input$gowt, {
    ...
    if(input$gowt==0)
      return()
setwd(path)
    source('3-cleaned/1-waterSimple.r')})
  ...
  pok1gh<- eventReactive(input$gogh, {
    ...
    if(input$gogh==0)
      return()
    setwd(path)
    source('3-cleaned/1-ghgSimple.r')
    })
  ...
  pok1bdiv<- eventReactive(input$gobdiv, {
    ...
    if(input$gobdiv==0)
      return()
    setwd(path)
    source('3-cleaned/1-biodivSimple.r')
    })
  ...
  psoil<- eventReactive(input$gosol, {
    ...
    if(input$gosol==0)
      return()
setwd(path)
   source('3-cleaned/1-soilSimple.r')
    })
